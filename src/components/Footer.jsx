...
function Footer() {
    return (
        <div className='w-full sm:p-12 p-4 bg-[#271B63] text-white'>
            <div className='grid grid-cols-1 sm:grid-cols-2'>
                ...
                <div className='sm:pl-12'>
                    ...
                    <p className='sm:py-8 py-2'>19 Abec Close, Awka Anambra,
                        Nigeria</p>

                    <div style={{ backgroundImage: `url(${Logo})` }} className="w-[82px] h-[31px]"></div>
                </div>
            </div>
            <div>
